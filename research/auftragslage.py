    ...
    def als_auftrag(self) -> str:
        ...
        if self.holdout is not None:
            ...
            zeilen += [
                ...
                "",
                "*Welche Schwelle dabei gilt, entscheidet alles* (Befund",
                "207). Bei z = 2,00 raeumt der Bestand vier von vier und zwei",
                "der zehn Partner immerhin zwei; rechnet man die bisherigen",
                "Versuche mit, verlangt die Schwelle **z = 3,48**, und dann",
                "steht es so:",
                "",
                "    Bestand                    2 von 4",
                ...
                "",
                "**Zwei von vier bei z = 3,48** ist damit die Latte - genau",
                "das, was der Bestand schafft und kein Partner. Sie ist kein",
                "Beleg fuer sich, sondern die Schwelle, unter der sich",
